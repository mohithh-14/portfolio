  ...
  const skillCategories = [
    {
      ...
      icon: Terminal,
      skills: [
        { name: "Java", percentage: 58, level: "Intermediate" },
        { name: "Python", percentage: 60, level: "Intermediate" },
        { name: "SQL", percentage: 55, level: "Intermediate" },
        { name: "C", percentage: 52, level: "Intermediate" },
        { name: "R", percentage: 50, level: "Intermediate" },
        { name: "HTML", percentage: 38, level: "Beginner" },
        { name: "CSS", percentage: 35, level: "Beginner" },
      ],
    ...
    },
    {
      ...
      icon: Code2,
      skills: [
        { name: "Spring Boot", percentage: 38, level: "Beginner" },
        { name: "React 19", percentage: 35, level: "Beginner" },
        { name: "JPA / Hibernate", percentage: 32, level: "Beginner" },
      ],
    ...
    },
    {
      ...
      icon: Library,
      skills: [
        { name: "Pandas", percentage: 58, level: "Intermediate" },
        { name: "NumPy", percentage: 58, level: "Intermediate" },
        { name: "Scikit-Learn", percentage: 55, level: "Intermediate" },
        { name: "Matplotlib", percentage: 52, level: "Intermediate" },
        { name: "Seaborn", percentage: 52, level: "Intermediate" },
        { name: "Tableau", percentage: 55, level: "Intermediate" },
        { name: "Qlik", percentage: 50, level: "Intermediate" },
      ],
    ...
    },
    {
      ...
      icon: Database,
      skills: [
        { name: "MySQL", percentage: 58, level: "Intermediate" },
        { name: "H2 Database", percentage: 52, level: "Intermediate" },
      ],
